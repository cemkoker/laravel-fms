<x-app-layout title="CRM Analytics Dashboard" is-header-blur="true">
    <main class="main-content">
        <div class="px-8 mt-8">
            <h2 class="text-base font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100 lg:text-xl pb-4">
                Coming next today
            </h2>
            <div class="flex space-x-4 ">
                @foreach ($todays as $meeting)
    ...
    <span
        class="absolute inline-block h-full w-full rounded-full bg-red-500 opacity-75 dark:bg-red-800"
    ></span>
                                    ...
                                    <div class="flex justify-between space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                                {{Str::ucfirst($meeting-> privacy)  }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        @if (strtolower($meeting->interpretation) == "none")
                                            <x-lang>NO INTERPRETATION</x-lang>
                                        @endif

                                        @if (Str::contains($meeting-> interpretation, 'A'))
                                            <x-lang>A</x-lang>
                                        @endif
                                        @if (Str::contains($meeting-> interpretation, 'C'))
                                            <x-lang>C</x-lang>
                                        @endif
                                        @if (Str::contains($meeting-> interpretation, 'E'))
                                            <x-lang>E</x-lang>
                                        @endif
                                        @if (Str::contains($meeting-> interpretation, 'F'))
                                            <x-lang>F</x-lang>
                                        @endif
                                        @if (Str::contains($meeting-> interpretation, 'S'))
                                            <x-lang>S</x-lang>
                                        @endif
                                        @if (Str::contains($meeting-> interpretation, 'R'))
                                            <x-lang>R</x-lang>
                                        @endif
                                    </div>
                                    <div class="grow">
                            ...
                            @else
                                <div class="card w-80 p-4 shrink-0 space-y-9 rounded-xl">
                                    ...
                                    <div class="flex items-center justify-between space-x-2">
                                        <div class="flex items-center space-x-3">
                                            <div class="avatar">
                                                <img class="mask is-squircle" src="{{ asset('images/xxiii.jpg') }}"
                                                     alt="image"/>
                                            </div>
                                            <div>
                                                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
