...
use App\Http\Controllers\ImportMeetings;
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/import', [ImportMeetings::class, 'import'])->name('import');
    ...
    Route::get('/layouts/blog-card-8', [PagesController::class, 'layoutsBlogCard7'])->name('layouts/blog-card-8');
